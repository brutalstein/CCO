...
This project adapts the [Contributor Covenant](https://www.contributor-covenant.org/),
...
reported to the maintainers via the private contact listed in `SECURITY.md`.
